...
2. Calculate the following information _*for each state*_ and prepare interactive visualizations that can help the user gain insights into the data:  
...
5. Use the above charts and visualizations and any others you think might help guide the decision-making at HUA. Remember that HUA's goal is to `provide assistance for low income and elderly taxpayers`. Your deliverable will be a single dashboard that includes what you think are the most important factors for HUA to consider.
